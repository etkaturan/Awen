...
type Tab = "speaking" | "vocabulary" | "grammar" | "settings" | "paragraph" | "listening";
    ...
    <div className="app-root">
      <header className="topbar">
        ...
        <nav className="nav-tabs">
          {(["speaking", "listening", "vocabulary", "grammar", "settings"] as Tab[]).map((t) => (
...
function tabIcon(t: Tab) {
  return { speaking: "🎙", listening: "🎧", vocabulary: "🃏", grammar: "📖", settings: "⚙️" }[t];
}
